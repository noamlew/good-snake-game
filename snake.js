...
function setUpLevel(lev) {
    ...
    switch (lev) {
        ...
        default:
            alert(
                "You have to finish all the levels up to here before you play that level!"
            );
            break;
    }
}
...
//#region $The Game
gameScreen.width = window.innerWidth - 10 - ((window.innerWidth - 10) % 30); // window.innerWidth - 36;
gameScreen.height = window.innerHeight - 10 - ((window.innerHeight - 10) % 30); // window.innerHeight - 32;
...
const cube = {
    w: 29, // gameScreen.width / 50 - 1, // => 29 + 1
    h: 29, // gameScreen.height / 23 - 1, // => 30 - 1
};
